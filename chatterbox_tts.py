...
# HugginFace Access tokens required [Profile -> Access Tokens -> New token -> write]
# Run -> [modal secret create hf-token HF_TOKEN="<your-hf-token>"] for adding HF token to modal
# Run -> [modal secret create chatterbox-api-key CHATTERBOX_API_KEY=<your-super-secret-key>] 
# Then add the R2 Token mentioned above. Do this in one-go bcoz its hard to append later!
# Finally to deploy run [modal deploy chatterbox_tts.py]
